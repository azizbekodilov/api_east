@section('title', 'Изменить каталог - EastMetProkat')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Изменить каталог</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="input-group">
                                        <img src="{{Illuminate\Support\Facades\URL::secure('/storage/catalogs/'.$this->media)}}" class="img-thumbnail">
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
