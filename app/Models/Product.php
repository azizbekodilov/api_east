...
class Product extends Model
{
    use Translatable;
    protected $fillable = [
        'media', 'catalog_id', 'partner_id', 'price', 'update_product_id', 'balance', 'thickness', 'width', 'length', 'dimensions', 'medium_tonnage', 'mark', 'status', 'is_discount', 'is_main_page', 'last_update_at', 'sort',
    ];
